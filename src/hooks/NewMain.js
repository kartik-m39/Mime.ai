...
export function NewThree(labelId, containerId) {
  ...
  if (wordList.length > 0 && wordList[wordidx]) {
    ...
    console.log("No words available yet. Three.js initialized and waiting for data.");
    // You might want to show a message on the label
    if (label) label.innerHTML = "WAITING FOR INPUT";
  }
}
